...
void helloWorld(){
    fillScreen(BLACK);
    drawChar(12, 64, 'H', 0xFFFF, 0x0000, 1);
    drawChar(18, 64, 'e', 0xFFFF, 0x0000, 1);
    drawChar(24, 64, 'l', 0xFFFF, 0x0000, 1);
    drawChar(30, 64, 'l', 0xFFFF, 0x0000, 1);
    drawChar(36, 64, 'o', 0xFFFF, 0x0000, 1);
    drawChar(42, 64, ' ', 0xFFFF, 0x0000, 1);
    drawChar(48, 64, 'w', 0xFFFF, 0x0000, 1);
    drawChar(54, 64, 'o', 0xFFFF, 0x0000, 1);
    drawChar(60, 64, 'r', 0xFFFF, 0x0000, 1);
    drawChar(64, 64, 'l', 0xFFFF, 0x0000, 1);
    drawChar(72, 64, 'd', 0xFFFF, 0x0000, 1);
}

void startingUpText() {
    fillScreen(BLACK);
    drawChar(12, 64, 'S', 0xFFFF, 0x0000, 1);
    drawChar(18, 64, 'T', 0xFFFF, 0x0000, 1);
    drawChar(24, 64, 'A', 0xFFFF, 0x0000, 1);
    drawChar(30, 64, 'R', 0xFFFF, 0x0000, 1);
    drawChar(36, 64, 'T', 0xFFFF, 0x0000, 1);
    drawChar(42, 64, 'I', 0xFFFF, 0x0000, 1);
    drawChar(48, 64, 'N', 0xFFFF, 0x0000, 1);
    drawChar(54, 64, 'G', 0xFFFF, 0x0000, 1);
    drawChar(60, 64, ' ', 0xFFFF, 0x0000, 1);
    drawChar(64, 64, 'U', 0xFFFF, 0x0000, 1);
    drawChar(72, 64, 'P', 0xFFFF, 0x0000, 1);
}

void updatingText() {
    fillScreen(BLACK);
    drawChar(12, 64, 'U', 0xFFFF, 0x0000, 1);
    drawChar(18, 64, 'P', 0xFFFF, 0x0000, 1);
    drawChar(24, 64, 'D', 0xFFFF, 0x0000, 1);
    drawChar(30, 64, 'A', 0xFFFF, 0x0000, 1);
    drawChar(36, 64, 'T', 0xFFFF, 0x0000, 1);
    drawChar(42, 64, 'I', 0xFFFF, 0x0000, 1);
    drawChar(48, 64, 'N', 0xFFFF, 0x0000, 1);
    drawChar(54, 64, 'G', 0xFFFF, 0x0000, 1);
